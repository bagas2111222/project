...
<div class="content">
    ...
    <div class="project">
        <!-- Projects -->
        <a href="/pegawai/projects"><button><b>back</b></button></a>
        <button type="button" class="btn btn-secondary" id="openModal3" hidden><i class='bx bx-plus-medical'></i> ADD</button>
            ...
            <tbody>
                @if (!empty($tahapan))
                    @foreach ($tahapan as $item)
                        <tr onclick="window.location='/pegawai/detail/{{ $item['id'] }}'"
