...
<div class="content">
    ...
    <div class="project">
        <!-- Projects -->
        <a href='/admin/tahapan/{{ $id_project }}'><button><b>back</b></button></a>
                ...
                <tbody>
                    @foreach ($detail as $tugas)
                        <tr onclick="window.location='{{ url('admin/output/' . $tugas['id']) }}'" style="cursor: pointer;">
                            ...
                            <td class="crud">
                                <button class="btn btn-danger" onclick="handleDelete(event, '{{ route('detail.destroy', $tugas->id) }}')">Delete</button>
                                <button class="btn btn-success editTaskBtn" data-id="{{ $tugas['id'] }}" 
                                        data-nama="{{ $tugas['name'] }}" 
                                        data-desc="{{ $tugas['desc'] }}" 
