  ...
  <div class="box">
    ...
    <div class="row-2">
      ...
      <table>
       ...
       <tbody>
          @foreach ($vendor as $key => $perusahaanItem)
            <tr>
              <td>{{ $key + 1 }}</td>
              ...
              <td style="width: 100px;">
                <a href="{{ route('vendor.destroy', $perusahaanItem->id) }}" data-confirm-delete="true"><button class="btn btn-danger">Delete</button></a>
...
<div class="popup" id="addPopup">
  <div class="popup-content">
    ...
    <form id="addForm" action="{{ route('addVendor') }}" method="post">
      @csrf
...
<div class="popup" id="editPopup">
  <div class="popup-content">
    ...
    <form id="editForm" action="{{ route('editVendor') }}" method="post">
      @csrf
